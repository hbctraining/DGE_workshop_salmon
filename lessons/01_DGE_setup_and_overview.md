...
Finally, we need to grab the files that we will be working with for the analysis. These are the Salmon results for the full dataset. Right click on the links below, and choose the "Save link as ..." option to download:
