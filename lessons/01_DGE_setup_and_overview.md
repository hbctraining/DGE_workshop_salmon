...
<img src="../img/screenshot_of_quantFile.png">
...
The first thing we need to do is create a variable that contains the paths to each of our `quant.sf` files:
